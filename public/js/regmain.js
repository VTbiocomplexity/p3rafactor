...
class Login_ {
  ...
  resetpass(evt) {
    ...
    return runFetch(fetchClient, 'http://www.patric.local:3000', '/auth/resetpass', fetchData, null, null, loginEmail);
  }
  ...
  logMeIn(evt) {
    ...
    return runFetch(fetchClient, 'http://www.patric.local:3000', '/auth/login', fetchData, generateSession, appName, null);
  }
  ...
  //     }
  //   };
  //   return fetchClient('http://www.patric.local:3000' + '/user/', fetchData)
  //   .then((response) => response.json())
  //   .then((data) => {
  //     console.log(data);
  //   });
...
class Register_ {
  ...
  createUser(evt) {
    ...
    return runFetch(fetchClient, 'http://www.patric.local:3000' + '/auth/signup', fetchData);
  }
...
},{"./classes/Login_.js":1,"./classes/Register_.js":2,"./commons/patric.js":3,"_process":6}],5:[function(require,module,exports){
